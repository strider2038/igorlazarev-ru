...
* Путь к файлу спецификации OpenAPI v3 (обязательный)
* Возможные значения: любой правильный URL-адрес или путь к файлу
...
* Значение по умолчанию: /dev/shm/openapi-cache
* Возможные значения: любой правильный путь к существующей директории
...
* Возможные значения: disabled, md5, md5_and_timestamp
